...
// Get pending loans with detailed information
$pending_query = "
    SELECT 
        l.*,
        u.first_name,
...
<head>
    ...
    <title>Pending Loans - Admin</title>
        ...
        <div id="content-wrapper">
            ...
            <div id="content">
                ...
                <div class="d-sm-flex justify-content-between align-items-center mb-4">
                    <div>
                        <h3 class="text-dark mb-0"><strong>PENDING LOANS</strong></h3>
                        <p class="text-muted mb-0">Loan applications awaiting review</p>
                    </div>
                    <div class="d-flex gap-2">
                        ...
                        <span class="badge bg-warning fs-6 p-2">
                            ...
                            <?php echo count($pending_loans); ?> Applications
                        </span>
                    </div>
                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="text-center p-3">
                                            <h1 class="text-warning mb-1"><?php echo count($pending_loans); ?></h1>
                                            <p class="text-muted mb-0">Pending Applications</p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="text-center p-3">
                                            <h1 class="text-warning mb-1">K<?php echo number_format($total_pending, 2); ?></h1>
                                    ...
                                    <div class="col-md-4">
                                        <div class="text-center p-3">
                                            <?php
                                            $avg_pending = count($pending_loans) > 0 ? $total_pending / count($pending_loans) : 0;
                                            ?>
                                            <h1 class="text-warning mb-1">K<?php echo number_format($avg_pending, 2); ?></h1>
                                            <p class="text-muted mb-0">Average Loan Size</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                <?php if (empty($pending_loans)): ?>
                                    <div class="text-center py-5">
                                        ...
                                        <h4 class="text-muted">No pending loan applications</h4>
                                        ...
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo htmlspecialchars($loan['admin_notes']); ?></td>
                                                    <td><?php echo date('M d, Y', strtotime($loan['application_date'])); ?></td>
                                                    <td>
                                                        <a href="loan_review.php?loan_number=<?php echo $loan['loan_number']; ?>" class="btn btn-sm btn-warning">
