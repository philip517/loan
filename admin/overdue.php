...
foreach ($overdue_loans as $loan) {
    ...
    $total_overdue_interest += $loan['interest'];
}
                                ...
                                <div class="card-body">
                                    <div class="row g-0 align-items-center">
                                        <div class="col me-2">
                                            ...
                                            <div class="text-xs text-muted">
                                                <span>Total: $<?php echo number_format($total_overdue_amount, 2); ?></span>
                                            </div>
                                        </div>
                                        <div class="col-auto">
                                ...
                                <div class="card-body">
                                    <div class="row g-0 align-items-center">
                                        <div class="col me-2">
                                            ...
                                            <div class="text-xs text-muted">
                                                <span>Total: $<?php echo number_format($total_current_amount, 2); ?></span>
                                            </div>
                                        </div>
                                        <div class="col-auto">
                                ...
                                <div class="card-body">
                                    <div class="row g-0 align-items-center">
                                        <div class="col me-2">
                                            ...
                                            <div class="text-dark mb-0 fw-bold h5">
                                                <span>$<?php echo number_format($total_overdue_interest + $total_current_interest, 2); ?></span>
                                            </div>
                                            <div class="text-xs text-muted">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3 bg-danger text-white d-flex justify-content-between align-items-center">
                                    ...
                                    <span class="badge bg-light text-danger fs-6">
                                        Total Overdue: $<?php echo number_format($total_overdue_amount, 2); ?>
                                    </span>
                                </div>
                                <div class="card-body">
                                            ...
                                            <table class="table table-sm table-hover" id="overdueTable">
                                                ...
                                                <tbody>
                                                    <?php foreach ($overdue_loans as $loan): ?>
                                                        ...
                                                        <tr class="<?php echo $days_overdue > 30 ? 'table-danger' : 'table-warning'; ?>">
                                                            ...
                                                            <td>
                                                                $<?php echo number_format($loan['interest'], 2); ?>
                                                            </td>
                                                            <td>
                                                                <strong class="text-danger">$<?php echo number_format($total_due, 2); ?></strong>
                                                            </td>
                                                            <td>
                                                            ...
                                                            <td>
                                                                <div class="btn-group btn-group-sm">
                                                                    <a href="loan_details.php?loan_id=<?php echo $loan['loan_id']; ?>" 
                                                ...
                                                <tfoot>
                                                    <tr class="table-secondary">
                                                        ...
                                                        <td><strong>$<?php echo number_format($total_overdue_amount, 2); ?></strong></td>
                                                        <td><strong>$<?php echo number_format($total_overdue_interest, 2); ?></strong></td>
                                                        <td><strong class="text-danger">$<?php echo number_format($total_overdue_amount + $total_overdue_interest, 2); ?></strong></td>
                                                        <td colspan="3"></td>
                                                    </tr>
                                                </tfoot>
                                            </table>
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3 bg-success text-white d-flex justify-content-between align-items-center">
                                    ...
                                    <span class="badge bg-light text-success fs-6">
                                        Total Current: $<?php echo number_format($total_current_amount, 2); ?>
                                    </span>
                                </div>
                                <div class="card-body">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-sm table-hover" id="currentTable">
                                                ...
                                                <tbody>
                                                    <?php foreach ($current_loans as $loan): ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <strong class="text-success">$<?php echo number_format($total_due, 2); ?></strong>
                                                            </td>
                                                            <td>
                                                                <?php echo date('M j, Y', strtotime($loan['loan_start_date'])); ?>
                                                            </td>
                                                ...
                                                <tfoot>
                                                    <tr class="table-secondary">
                                                        <td colspan="4" class="text-end"><strong>Totals:</strong></td>
                                                        <td><strong>$<?php echo number_format($total_current_amount, 2); ?></strong></td>
                                                        <td><strong>$<?php echo number_format($total_current_interest, 2); ?></strong></td>
                                                        <td><strong class="text-success">$<?php echo number_format($total_current_amount + $total_current_interest, 2); ?></strong></td>
                                                        <td colspan="3"></td>
                                                    </tr>
                                                </tfoot>
                                            </table>
