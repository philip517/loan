...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['send_message'])) {
    ...
    if (!empty($topic) && !empty($message_text)) {
        try {
            ...
            header("Location: loan_messages.php?loan_id=" . $loan_id);
            exit();
        } catch (PDOException $e) {
                        ...
                        <div class="card-body">
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-4 text-end">
                                    <a href="loan_review.php?loan_id=<?php echo $loan_id; ?>" class="btn btn-light me-2">
                                        <i class="fas fa-eye me-1"></i>View Loan
                                    </a>
                                    <a href="message.php" class="btn btn-outline-light">
                                            ...
                                            ?>
                                                <div class="message-bubble p-3 <?php echo $isAdmin ? 'admin-message' : 'user-message'; ?>">
                                                    <div class="d-flex justify-content-between align-items-start mb-2">
                                                        <strong>
                                                            <?php echo $isAdmin ? 'Admin' : ($loan['first_name'] . ' ' . $loan['last_name']); ?>
                                                        </strong>
