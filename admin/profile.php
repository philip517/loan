...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['update_credentials'])) {
        ...
        $stmt = $pdo->prepare("UPDATE user_table SET username=?, email=?, first_name=?, last_name=? WHERE id=?");
    ...
    if (isset($_POST['update_personal'])) {
        ...
        $stmt = $pdo->prepare("UPDATE user_table SET date_of_birth=?, phone=?, address=?, NRC=?, gender=?, occupation=? WHERE id=?");
    ...
    if (isset($_POST['update_password'])) {
        ...
        if ($new_password === $confirm_password) {
            $stmt = $pdo->prepare("UPDATE admins SET password=?, reset_phrase=? WHERE id=?");
                                ...
                                <form method="post" class="user">
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <input class="form-control form-control-user" type="text" id="date_of_birth" name="date_of_birth" value="<?= htmlspecialchars($admin['date_of_birth'] ?? '') ?>">
                                        </div>
                                        <div class="col">
                            ...
                            <div class="card-body">
                                ...
                                <form method="post" class="user">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control form-control-user" type="password" id="new_password" name="new_password" placeholder="***************">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label" for="com_password"><strong>Confirm New Password</strong></label>
                                        <input class="form-control form-control-user" type="password" id="com_password" name="com_password" placeholder="***************">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label" for="reset_phrase"><strong>Reset Phrase</strong></label>
                                        <input class="form-control form-control-user" type="text" id="reset_phrase" name="reset_phrase" value="<?= htmlspecialchars($admin['reset_phrase'] ?? '') ?>">
                                    </div>
