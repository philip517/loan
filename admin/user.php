        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid" style="margin-top: 100px;">
                    <div class="row">
                        <div class="col col-sm-10 col-md-12 col-lg-auto col-xl-12 col-xxl-12">
                            <div class="card shadow mb-3">
                                <div class="card-header py-3">
                                    <p class="text-primary m-0 fw-bold">User Name</p>
                                </div>
                                <div class="card-body">
                                    <form>
                                        <div class="row">
                                        ...
                                        <div class="text-center mb-3"><a class="btn btn-primary btn-sm ms-4 mt-2" role="button" href="#modal-2" data-bs-target="#modal-2" data-bs-toggle="modal" style="background: #ee796e;color: var(--bs-light);">Delete User</a></div>
                                    </form>
                                </div>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header" style="text-align: center;">
                                                <h4 class="modal-title" style="text-align: center;width: 100%;">Delete User</h4>
                                            </div>
                                            <div class="modal-body" style="height: 173.3px;width: 100%;">
                                                <form>
                                                    <div class="row">
                                                        <div class="col">
                                                    ...
                                                    <div class="row">
                                                        <div class="col">
                                                            <div class="mb-3"><label class="form-label" for="first_name-1"><strong>Comfirm Admin Password</strong></label><input class="form-control" type="password" name="com_password" placeholder="******************"></div>
                                                        </div>
                                                    </div>
                                                    <div class="text-center mb-3"><button class="btn btn-light" type="button" data-bs-dismiss="modal" style="background: var(--bs-success);border-color: var(--bs-success);">No</button><a class="btn btn-success btn-sm ms-9" role="button" style="--bs-body-color: rgba(51,69,204,0.37);background: var(--bs-danger-border-subtle);border-color: var(--bs-secondary-bg-subtle);" href="profile.php" target="_top">Yes</a></div>
                                                </form>
                                            </div>
