                                ...
                                <div class="p-5"><img src="assets/img/white%20logo.png" width="79" height="81">
                                    <div class="text-center">
                                        ...
                                        <form class="user">
                                            ...
                                            <div class="mb-3 row">
                                                <div class="col-sm-6 mb-3 mb-sm-0"><input class="form-control form-control-user" type="password" id="password" name="password" value="" title="password" placeholder="Password"></div>
                                                <div class="col-sm-6"><input class="form-control form-control-user" type="email" id="email" placeholder="example@gmail.com"></div>
                                            </div>
                                            <hr>
                                            <h4 class="text-center text-dark mb-4">
                                                <div class="btn-group" role="group"><button class="btn btn-primary form-control-user" id="submit" type="submit">Create Account</button></div>
                                            </h4>
                                        </form>
                                    </div>
