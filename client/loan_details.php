...
// Fetch specific loan details for this user only
try {
...
// Handle message submission to admin
    ...
    <div class="card shadow-lg border-0 mb-4">
        <div class="card-header bg-white py-3">
            <div class="row align-items-center">
                <div class="col">
                    <h4 class="mb-1">Loan Application Details</h4>
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-md-4 text-center">
                                    ...
                                    <img src="' . $user_id_image_src . '" class="img-fluid clickable-image" 
                                         style="max-height: 150px; max-width: 100%; cursor: pointer;" 
                                         alt="ID Document" 
                                         onclick="openImageModal(\'' . $user_id_image_src . '\', \'ID Document\')">
                ...
                <div class="col-12">
                    <div class="card shadow-sm">
                        <div class="card-header bg-dark text-white">
                            <h5 class="mb-0"><i class="fas fa-envelope me-2"></i>Contact Administrator</h5>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="mt-3 text-end">
                                <a href="my_loans.php" class="btn btn-secondary">
...
<head>
    ...
    <meta name="description" content="Loan Details Page">
