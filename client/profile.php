            ...
            <div class="container-fluid" style="margin-top:100px;">
                ...
                <div class="row d-flex justify-content-center mb-3">
                    <div class="col-lg-8">
                            ...
                            <div class="card-body">
                                <form method="post" class="user">
                                    ...
                                    <div class="d-flex justify-content-center">
                                        <button class="btn btn-primary btn-sm mt-3" type="submit" style="width: auto; min-width: 150px;">Save Settings</button>
                                    </div>
                                </form>
                            </div>
                        </div>
                        ...
                        <!-- Personal Details -->
                        <div style="margin-top:40px;"class="card shadow mb-3">
                            ...
                            <div class="card-body">
                                <form method="post" class="user">
                                    ...
                                    <div class="d-flex justify-content-center">
                                        <button class="btn btn-primary btn-sm mt-3" type="submit" style="width: auto; min-width: 150px;">Save Personal Details</button>
                                    </div>
                                </form>
                            </div>
                        </div>
                        ...
                        <div style="margin-top:40px;"class="card shadow mb-3">
                            ...
                            <div class="card-body">
                                ...
                                <form method="post" class="user" >
                                    ...
                                    <div class="d-flex justify-content-center">
                                        <button class="btn btn-primary btn-sm mt-2" type="submit" style="width: auto; min-width: 150px;">Save Password</button>
                                    </div>
                                </form>
                            </div>
                        </div>
